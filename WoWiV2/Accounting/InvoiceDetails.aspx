...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
  ...
  &nbsp;<asp:Button ID="Button1" runat="server" OnClientClick="openPrintWin();" Text="View/Print" />
        ...
        <asp:GridView ID="iGridView2" runat="server" Width="100%" AutoGenerateColumns="False"
          ...
          <Columns>
            ...
            <asp:TemplateField HeaderText="TDescription">
              ...
              <FooterTemplate>
                <asp:TextBox ID="tbbankAccount" runat="server" Height="180" Width="530" TextMode="MultiLine"
                ...
                <table align="right">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <asp:TextBox ID="tbdiscount" runat="server" Enabled="false" AutoPostBack="True"></asp:TextBox>
                    </td>
                  </tr>
                  <tr>
                    <td align="right">
                    ...
                    <td>
                      ...
                      <asp:TextBox ID="tbTax" runat="server" Enabled="false" AutoPostBack="True"></asp:TextBox>
                    </td>
                  </tr>
                  <tr>
                    <td align="right">
