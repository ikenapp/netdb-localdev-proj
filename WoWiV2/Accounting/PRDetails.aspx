...
<script runat="server">
  ...
  protected void HistoryPanel_Load(object sender, EventArgs e)
  {
    if (!String.IsNullOrEmpty(Request.QueryString["id"]))
    {
      ...
      try
      {
        var data = from c in wowidb.PR_authority_history
                   where c.pr_id == id && c.status == (byte)PRStatus.History
                   select new
                   {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
        ...
        <tr>
          <th align="left" class="style10">
            <font size="+1">&nbsp;Purchase Request 
                 ...
                 &nbsp;</font>
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Accounting/PRList.aspx">PR List</asp:HyperLink>&#160;
          </th>
        </tr>
        <tr>
          <td>
            <table align="center" border="1" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td width="30%">
                  <asp:DropDownList ID="ddlDeptList" runat="server" Enabled="false" DataSourceID="SqlDataSource2"
                ...
                <td width="30%">
                  <asp:DropDownList ID="ddlEmployeeList" runat="server" AppendDataBoundItems="true"
                    Enabled="false" SelectedValue='<%# Bind("employee_id") %>' OnLoad="ddlEmployeeList_Load">
                    <asp:ListItem Value="-1">- Select -</asp:ListItem>
                  </asp:DropDownList>
                </td>
              </tr>
              <tr>
                <th align="left">
                  &nbsp;&nbsp;&nbsp; <span class="style14"><strong>Project No.:&nbsp;</strong></span>&nbsp;
                </th>
                <td width="30%">
              ...
              <tr>
                ...
                <td class="style12" width="30%">
                  <asp:Label ID="tbVenderQuoNo" runat="server" Text='<%# Bind("vendor_quotation_no")%>'></asp:Label>
                </td>
                <th align="left" class="style11">
                  &nbsp; Vender Invoice No.:&nbsp;
                </th>
                <td class="style12" width="30%">
                  <asp:Label ID="tbVenderInvoNo" runat="server" Text='<%# Bind("vendor_invoice_no")%>'></asp:Label>
                </td>
              </tr>
              <tr>
                <th align="left">
                  &nbsp;&nbsp; <span class="style15">Payment Term:&nbsp;</span>&nbsp;
                </th>
                <td colspan="3">
                  <asp:DropDownList ID="ddlPaymentTerm" runat="server" Enabled="false" SelectedValue='<%# Bind("payment_term") %>'
                    Font-Bold="True">
              ...
              <tr>
                ...
                <td class="style12" colspan="3">
                  <asp:Button ID="Button1" runat="server" Text="Attach Files" OnClientClick="openAttachWin()"
              ...
              <tr>
                <th align="left">
                  &nbsp;&nbsp; <span class="style15">Target:&nbsp;</span>&nbsp;
                </th>
                <td colspan="3">
                  <asp:DropDownList ID="ddlTarget" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                    OnLoad="ddlTarget_Load" Enabled="false" Font-Bold="True">
                    <asp:ListItem Value="-1">- Select -</asp:ListItem>
                  </asp:DropDownList>
                  &nbsp;
                </td>
              ...
              <tr>
                <th align="left" class="style13">
                  <span class="style12">&nbsp;&nbsp;&nbsp;Authorization Currency:&nbsp;&nbsp;</span>
                </th>
                <td class="style13" width="30%">
                  USD </span>
                </td>
              ...
              <tr>
                ...
                <td class="style12" colspan="3">
                  <asp:DropDownList ID="ddlVenderList" runat="server" Enabled="false" AppendDataBoundItems="True"
                    AutoPostBack="True" OnLoad="ddlVenderList_Load">
              ...
              <asp:Panel ID="VenderPanel" runat="server" Visible="false">
                        ...
                        <td>
                          <table align="center" border="1" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                              ...
                              <td width="30%">
                                <asp:DropDownList ID="ddlCountry" runat="server" Enabled="false" DataSourceID="SqlDataSource1"
                            ...
                            <tr>
                              ...
                              <td width="30%">
                                <asp:DropDownList DataSourceID="SqlDataSource3" DataTextField="name" DataValueField="id"
                              ...
                              <td align="left" class="style2" colspan="4">
                                <table border="0" cellpadding="2" cellspacing="0" style="width: 100%">
                                  <tr>
                                    ...
                                    <td width="50%">
                                      <asp:DropDownList ID="ddlPaymentTerm1" runat="server" OnLoad="DropDownList1_Load"
                                        Enabled="false">
                                      </asp:DropDownList>
                                      %
                                  ...
                                  <tr>
                                    ...
                                    <td width="50%">
                                      <asp:DropDownList ID="ddlPaymentTerm2" runat="server" OnLoad="DropDownList1_Load"
                                        Enabled="false">
                                      </asp:DropDownList>
                                      %
                                  ...
                                  <tr>
                                    ...
                                    <td width="50%">
                                      <asp:DropDownList ID="ddlPaymentTerm3" runat="server" OnLoad="DropDownList1_Load"
                                        Enabled="false">
                                      </asp:DropDownList>
                                      %
                                  ...
                                  <tr>
                                    ...
                                    <td width="50%">
                                      <asp:DropDownList ID="ddlPaymentTermF" runat="server" OnLoad="DropDownList1_Load"
                                        Enabled="false">
                                      </asp:DropDownList>
                                      %
                ...
                <tr>
                  <td align="left" colspan="4">
                    <asp:Label runat="server" ID="lblC" Text="Contact :"></asp:Label><asp:DropDownList
                      AutoPostBack="True" ID="ddlContact" runat="server" Enabled="false">
                    </asp:DropDownList>
                ...
                <tr>
                  <td align="left" colspan="4">
                    ...
                    <asp:DropDownList AutoPostBack="True" Enabled="false" ID="ddlBankAccount" runat="server">
                    </asp:DropDownList>
                  </td>
                </tr>
                <tr>
              ...
              <tr align="center">
                ...
                <td>
                  <asp:TextBox ID="tbInternalMarks" runat="server" Height="150px" TextMode="MultiLine"
                    Width="510px" OnLoad="AuthLabel_Load"></asp:TextBox>
                </td>
                <td>
                </td>
                <td>
                  <asp:TextBox ID="tbInstruction" runat="server" Height="150px" TextMode="MultiLine"
              ...
              <tr>
                ...
                <td>
                  <asp:Button ID="btnCancel" runat="server" Text="Withdraw" OnClick="btnCancel_Click"
                    Enabled="false" />
                </td>
                <td>
                </td>
  ...
  <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=WoWiEntities"
    DefaultContainerName="WoWiEntities" EnableInsert="True" EntitySetName="PRs" Where="it.pr_id == @id"
    EnableUpdate="True">
    <WhereParameters>
