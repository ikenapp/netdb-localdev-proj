...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" 
            NavigateUrl="~/Admin/ContactRoleList.aspx">Contact Role List</asp:HyperLink>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            InsertCommand="INSERT INTO [contact_role] ([contact_name], [publish], [create_date], [create_user], [modify_date], [modify_user]) VALUES (@name, @publish, @create_date, @create_user, @modify_date, @modify_user)" 
            UpdateCommand="UPDATE [contact_role] SET [contact_name] = @name, [publish] = @publish, [create_date] = @create_date, [create_user] = @create_user, [modify_date] = @modify_date, [modify_user] = @modify_user WHERE [contact_id] = @id">
            <DeleteParameters>
