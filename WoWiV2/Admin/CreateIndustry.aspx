...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" 
            NavigateUrl="~/Admin/IndustryList.aspx">Industry List</asp:HyperLink>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            InsertCommand="INSERT INTO [clientapplicant_industry] ([name], [publish], [create_date], [create_user], [modify_date], [modify_user]) VALUES (@name, @publish, @create_date, @create_user, @modify_date, @modify_user)" 
            UpdateCommand="UPDATE [clientapplicant_industry] SET [name] = @name, [publish] = @publish, [create_date] = @create_date, [create_user] = @create_user, [modify_date] = @modify_date, [modify_user] = @modify_user WHERE [id] = @id">
            <DeleteParameters>
