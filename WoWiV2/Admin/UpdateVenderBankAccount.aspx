...
<script runat="server">
  ...
  protected void EntityDataSource1_Inserting(object sender, EntityDataSourceChangingEventArgs e)
  {
    ...
    obj.isWestUnit = false;
    obj.vender_id = id;
    obj.create_date = DateTime.Now;
    obj.create_user = User.Identity.Name;
  }

  protected void EntityDataSource4_Inserting(object sender, EntityDataSourceChangingEventArgs e)
  {
    WoWiModel.venderbanking obj = (WoWiModel.venderbanking)e.Entity;
    obj.isWestUnit = true;
    obj.vender_id = id;
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        //isWestUnitStr += "&paymenttype=" + paymentType;        
      }
      catch (Exception)
      {
        //throw;
  ...
  protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
  {
    if (e.CommandName == "MySelect")
    {
      ...
      int bankid = int.Parse(row.Cells[5].Text);
      //FormView4.Visible = true;
  ...
  protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
  {
    ...
    {
      String paymentType = e.Row.Cells[1].Text;
      try
      {
        e.Row.Cells[1].Text = VenderUtils.GetPaymentType(paymentType);
      }
      catch (Exception)
      {
        //throw;
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
  <font size="+1">Vender Bank Account Information Modification&#160; </font>
  <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Admin/VenderList.aspx">Vender List</asp:HyperLink>&#160;
  <asp:Button ID="Button1" runat="server" Text="Create Bank Info" OnClick="Button1_Click"
    CausesValidation="False" />
  <asp:Button ID="LinkButton3" runat="server" Text="Contact Modification" OnClick="LinkButton1_Click"
    CausesValidation="False" />
  <asp:Button ID="LinkButton4" runat="server" Text="Finish" OnClick="LinkButton2_Click"
    CausesValidation="False" />
      ...
      <table align="left" border="0" cellpadding="2" cellspacing="0" style="width: 100%">
        <tr>
          <th align="left" class="style10">
            <font size="+1">Basic Bank Account Information</font>
          </th>
        </tr>
        <tr>
          <td>
            <table align="center" border="1" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <th align="left" class="style9">
                  &nbsp&nbsp Payment Type:&#160;
                </th>
                <td width="30%" colspan="3">
                  <asp:DropDownList ID="ddlPaymentType2" runat="server" OnPreRender="ddlPaymentType_PreRender"
                    SelectedValue='<%# Bind("payment_type") %>' OnSelectedIndexChanged="ddlPaymentType_SelectedIndexChanged">
                  ...
                  &nbsp;<font color="red"><b>*</b></font>國內匯款 不需輸入&nbsp;<font color="red">Swif Code</font>&nbsp;，支票
                  或是 匯票 &nbsp;<font color="red">Beneficiary Name</font>&nbsp;一定要輸入，空白欄位一律填入&nbsp;<font
                    color="red">N/A</font>&nbsp;
                </td>
              </tr>
              <tr>
                ...
                <td width="30%">
                  ...
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbBankName"
                    ErrorMessage="Have to provide Bank Name " ForeColor="Red" ValidationGroup="f2">*</asp:RequiredFieldValidator>
                </td>
                <th align="left" class="style7">
                  &nbsp;&nbsp; Branch Name:&nbsp;
                </th>
                <td width="30%">
                  <asp:TextBox ID="tbBranchName" runat="server" Text='<%# Bind("bank_branch_name") %>'></asp:TextBox>
                </td>
                <tr>
                  <th align="left" class="style2">
                    <font color="red">*&nbsp;</font>Swif Code:&nbsp;
                  </th>
                  <td class="style3" width="30%">
                    <asp:TextBox ID="tbSwif" runat="server" Text='<%# Bind("bank_swifcode") %>'></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="tbSwif"
                      ErrorMessage="Have to provide Swift Code" ForeColor="Red" ValidationGroup="f2">*</asp:RequiredFieldValidator>
                  </td>
                  <th align="left" class="style9">
                    &nbsp;&nbsp; Bank Address:&nbsp;
                  </th>
                  <td width="30%">
                    <asp:TextBox ID="tbBankAddress" runat="server" Text='<%# Bind("bank_address") %>'
                      Width="360"></asp:TextBox>
                  </td>
                </tr>
              <tr>
                <th align="left" class="style7">
                  <font color="red">*&nbsp;</font>Account No.(IBAN):&nbsp;&nbsp;
                </th>
                <td width="30%">
                  <asp:TextBox ID="tbBankAccountNo" runat="server" MaxLength="31" Text='<%# Bind("bank_account_no") %>'
                    Width="250"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="tbBankAccountNo"
                    ErrorMessage="Have to provide Account No." ForeColor="Red" ValidationGroup="f2">*</asp:RequiredFieldValidator>
                </td>
                <th align="left" class="style7">
                  &nbsp;&nbsp; Bank Telephone:
                </th>
              ...
              <tr>
                ...
                <td>
                  <asp:TextBox ID="tbBankRoutingNo" runat="server" MaxLength="50" Text='<%# Bind("bank_routing_no") %>'
                    Width="250"></asp:TextBox>
                </td>
                <th align="left" class="style7">
                  <font color="red">*&nbsp;</font>Beneficiary Name:
                </th>
                <td class="style3" width="30%">
                  <asp:TextBox ID="tbBeneficiaryName" runat="server" Text='<%# Bind("bank_beneficiary_name") %>'
                    Width="300"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="tbBeneficiaryName"
                    ErrorMessage="Have to provide Beneficiary Name" ForeColor="Red" ValidationGroup="f2">*</asp:RequiredFieldValidator>
                </td>
              </tr>
              <tr>
                <th align="left" class="style2">
                ...
                <td class="style3" colspan="3" width="30%">
                  <asp:TextBox ID="TextBox1" runat="server" Height="100" Text='<%# Bind("bank_comments") %>'
              ...
              <tr align="center">
                <td>
                  <asp:LinkButton ID="InsertButton" runat="server" CausesValidation="True" CommandName="Insert"
                    Text="Create" ValidationGroup="f2" />
                  <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" Text="Cancel"
                    OnClick="Button2_Click" ValidationGroup="f2" />
                  <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True"
                    ShowSummary="False" ValidationGroup="f2" />
                </td>
              </tr>
            </table>
          </td>
  ...
  <asp:FormView ID="FormView3" runat="server" DataKeyNames="id" SkinID="FormView" Visible="False"
    DataSourceID="EntityDataSource4" DefaultMode="Insert" Width="100%">
    <InsertItemTemplate>
      <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional"><ContentTemplate>--%>
      <table align="left" border="0" cellpadding="2" cellspacing="0" style="width: 100%">
        <tr>
          <th align="left" class="style10">
            <font size="+1">Special Bank Account Information</font>
          </th>
        </tr>
        <tr>
          <td>
            <table align="center" border="1" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                ...
                <td>
                  <asp:DropDownList ID="ddlPaymentTypeCreate" runat="server" SelectedValue='<%# Bind("payment_type") %>'>
                ...
                <td>
                  <asp:TextBox ID="tbWuDestination" runat="server" Text='<%# Bind("wu_destination") %>'></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="tbWuDestination"
                    ErrorMessage="Have to provide Destination " ForeColor="Red" ValidationGroup="f3">*</asp:RequiredFieldValidator>
                </td>
              </tr>
              <tr>
                <th align="left" class="style9">
                ...
                <td width="30%">
                  <asp:TextBox ID="tbWuFirstName" runat="server" Text='<%# Bind("wu_first_name") %>'></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbWuFirstName"
                    ErrorMessage="Have to provide First Name " ForeColor="Red" ValidationGroup="f3">*</asp:RequiredFieldValidator>
                </td>
                <th align="left" class="style9">
                  <font color="red">*&nbsp;</font>Last Name:&#160;
                </th>
                <td width="30%">
                  <asp:TextBox ID="tbWuLastName" runat="server" Text='<%# Bind("wu_last_name") %>'></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="tbWuLastName"
                    ErrorMessage="Have to provide Last Name " ForeColor="Red" ValidationGroup="f3">*</asp:RequiredFieldValidator>
                </td>
              </tr>
            </table>
          </td>
          ...
          <td class="style4">
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr align="center">
                <td>
                  <asp:LinkButton ID="InsertButton" runat="server" CausesValidation="True" CommandName="Insert"
                    Text="Create" ValidationGroup="f3" />&#160;&nbsp;<asp:LinkButton ID="InsertCancelButton"
                      runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" ValidationGroup="f3" />&#160;
                  &nbsp;<asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" Text="Next"
                    OnClick="LinkButton1_Click" />
                  <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True"
                    ShowSummary="False" ValidationGroup="f3" />
                </td>
              </tr>
            </table>
          </td>
  ...
  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
    ...
    <Columns>
      <asp:TemplateField ShowHeader="False">
        <ItemTemplate>
          <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="MySelect"
  ...
  <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Width="100%"
    AllowPaging="True" PageSize="5" DataSourceID="SqlDataSource2" OnRowCommand="GridView2_RowCommand"
  ...
  <asp:EntityDataSource ID="EntityDataSource2" runat="server" ConnectionString="name=WoWiEntities"
    DefaultContainerName="WoWiEntities" EnableFlattening="False" EnableInsert="False"
    EntitySetName="venderbankings" OnUpdated="EntityDataSource1_Updated" Where="it.vender_id == @id"
    OnUpdating="EntityDataSource1_Updating" EnableUpdate="True">
    <WhereParameters>
      <asp:QueryStringParameter Name="id" QueryStringField="id" Type="Int32" />
    </WhereParameters>
  </asp:EntityDataSource>
  <asp:FormView ID="FormView1" runat="server" DataKeyNames="bank_id" SkinID="FormView"
    DataSourceID="EntityDataSource1" Visible="false" DefaultMode="Edit" 
    Width="100%">
    <EditItemTemplate>
                ...
                <table align="center" border="1" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <tr>
                    ...
                    <td width="30%" colspan="3">
                      <asp:DropDownList ID="ddlPaymentType" runat="server" SelectedValue='<%# Bind("payment_type") %>'
                        OnPreRender="ddlPaymentType_PreRender2" OnSelectedIndexChanged="ddlPaymentType_SelectedIndexChanged">
                        <asp:ListItem Value="-1">- Select -</asp:ListItem>
                        <asp:ListItem Value="0">支票 Check</asp:ListItem>
                        <asp:ListItem Value="1">國內匯款 Domestic Wire Transfer</asp:ListItem>
                        <asp:ListItem Value="6">國外匯款 Foreign  Wire Transfer</asp:ListItem>
                      ...
                      或是 匯票 &nbsp;<font color="red">Beneficiary Name</font>&nbsp;一定要輸入，空白欄位一律填入&nbsp;<font
                        color="red">N/A</font>&nbsp;
                      <asp:Label ID="lblPaymentType" runat="server" Text='<%# Bind("payment_type") %>'
                  ...
                  <tr>
                    ...
                    <td width="30%">
                      <asp:TextBox ID="tbBankName" runat="server" Text='<%# Bind("bank_name") %>'></asp:TextBox>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbBankName"
                        ErrorMessage="Have to provide Bank Name " ForeColor="Red">*</asp:RequiredFieldValidator>
                    </td>
                    <th align="left" class="style7">
                      &nbsp;&nbsp; Branch Name:&nbsp;
                    </th>
                    ...
                    <tr>
                      ...
                      <td class="style3" width="30%">
                        <asp:TextBox ID="tbSwif" runat="server" Text='<%# Bind("bank_swifcode") %>'></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="tbSwif"
                          ErrorMessage="Have to provide Swift Code" ForeColor="Red">*</asp:RequiredFieldValidator>
                      </td>
                      <th align="left" class="style9">
                        &nbsp;&nbsp; Bank Address:&nbsp;
                      </th>
                  ...
                  <tr>
                    ...
                    <td width="30%">
                      <asp:TextBox ID="tbBankAccountNo" runat="server" MaxLength="31" Text='<%# Bind("bank_account_no") %>'
                        Width="250"></asp:TextBox>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="tbBankAccountNo"
                        ErrorMessage="Have to provide Account No." ForeColor="Red">*</asp:RequiredFieldValidator>
                    </td>
                    <th align="left" class="style7">
                      &nbsp;&nbsp; Bank Telephone:
                    </th>
            ...
            <tr>
              <td class="style4">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr align="center">
                    <td>
                      <asp:LinkButton ID="UpdateButton2" runat="server" CausesValidation="True" CommandName="Update"
                        Text="Update" />&#160;&nbsp;<asp:LinkButton ID="UCancelButton" runat="server" CausesValidation="False"
  ...
  <asp:FormView ID="FormView4" runat="server" DataKeyNames="bank_id" SkinID="FormView"
    DataSourceID="EntityDataSource1" Visible="false" DefaultMode="Edit" 
    Width="100%">
    <EditItemTemplate>
      <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
              ...
              <td>
                <table align="center" border="1" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    ...
                    <td>
                      <asp:DropDownList ID="ddlPaymentTypeUpdate" runat="server" SelectedValue='<%# Bind("payment_type") %>'>
                        <asp:ListItem Value="5">西聯匯款 Western Union</asp:ListItem>
                        <asp:ListItem Value="7">速匯金 MoneyGram</asp:ListItem>
                      </asp:DropDownList>
                    </td>
                    ...
                    <td>
                      <asp:TextBox ID="tbWuDestination" runat="server" Text='<%# Bind("wu_destination") %>'></asp:TextBox>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="tbWuDestination"
                        ErrorMessage="Have to provide Destination " ForeColor="Red">*</asp:RequiredFieldValidator>
                    </td>
                  </tr>
                  <tr>
                    <th align="left" class="style9">
                    ...
                    <td width="30%">
                      <asp:TextBox ID="tbWuFirstName" runat="server" Text='<%# Bind("wu_first_name") %>'></asp:TextBox>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="tbWuFirstName"
                        ErrorMessage="Have to provide First Name " ForeColor="Red">*</asp:RequiredFieldValidator>
                    </td>
                    <th align="left" class="style9">
                      <font color="red">*&nbsp;</font>Last Name:&#160;
                    </th>
                    <td width="30%">
                      <asp:TextBox ID="tbWuLastName" runat="server" Text='<%# Bind("wu_last_name") %>'></asp:TextBox>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="tbWuLastName"
                        ErrorMessage="Have to provide Last Name " ForeColor="Red">*</asp:RequiredFieldValidator>
                    </td>
                  </tr>
                </table>
              </td>
                    ...
                    <tr align="center">
                      <td>
                        ...
                        <asp:LinkButton ID="UpdateCancelButton1" runat="server" CausesValidation="False"
                          CommandName="Cancel" Text="Cancel" Visible="false" />
                        <asp:LinkButton ID="LinkButton11" runat="server" CausesValidation="False" Text="Next"
                          OnClick="LinkButton1_Click" />
  ...
  <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=WoWiEntities"
    DefaultContainerName="WoWiEntities" EnableFlattening="False" EnableInsert="False"
    EntitySetName="venderbankings" OnUpdated="EntityDataSource1_Updated" Where="it.bank_id == @id"
    OnUpdating="EntityDataSource1_Updating" EnableUpdate="True">
    <WhereParameters>
      <asp:QueryStringParameter Name="id" QueryStringField="bid" Type="Int32" />
    </WhereParameters>
  </asp:EntityDataSource>
  <asp:EntityDataSource ID="EntityDataSource3" runat="server" ConnectionString="name=WoWiEntities"
    DefaultContainerName="WoWiEntities" EnableFlattening="False" EnableInsert="True"
    EntitySetName="venderbankings" OnInserted="EntityDataSource1_Inserted" OnInserting="EntityDataSource1_Inserting"
    EnableDelete="False" EnableUpdate="False">
  </asp:EntityDataSource>
  <asp:EntityDataSource ID="EntityDataSource4" runat="server" ConnectionString="name=WoWiEntities"
    DefaultContainerName="WoWiEntities" EnableFlattening="False" EnableInsert="True"
    EntitySetName="venderbankings" OnInserted="EntityDataSource1_Inserted" OnInserting="EntityDataSource4_Inserting"
    EnableDelete="False" EnableUpdate="False">
  </asp:EntityDataSource>
  ...
  <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:WoWiConnectionString %>"
    SelectCommand="SELECT * FROM [venderbanking] WHERE (([vender_id] = @vender_id) AND ([isWestUnit] = @isWestUnit))">
    <SelectParameters>
      <asp:QueryStringParameter Name="vender_id" QueryStringField="id" Type="Int32" />
