<%@ WebHandler Language="C#" Class="ApplicationFile" %>
...
public class ApplicationFile : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        if ((context.Request["fid"] != null))
        {
            ...
            cmd.CommandText = "select * from Ima_Application_Files where ApplicationFileID=@ApplicationFileID";
            cmd.Parameters.AddWithValue("@ApplicationFileID", context.Request["fid"]);
