<%@ WebHandler Language="C#" Class="GoverFile" %>
...
public class GoverFile : IHttpHandler
{    
    public void ProcessRequest (HttpContext context) {        
        if ((context.Request["fid"] != null)) 
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "select * from Ima_GoverAuth_Files where GoverAuthFileID=@GoverAuthFileID";
            cmd.Parameters.AddWithValue("@GoverAuthFileID", context.Request["fid"]);
