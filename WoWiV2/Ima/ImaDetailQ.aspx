<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImaDetailQ.aspx.cs" Inherits="Ima_ImaDetailQ" StylesheetTheme="IMA" %>
                    ...
                    <table cellpadding="1" cellspacing="1" border="0" class="tbEditItem">
                        ...
                        <tr>
                            ...
                            <td class="tdRowValue" align="left">
                                <asp:Label ID="lblAccreditedLab" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdRowName">
