                    ...
                    <tr id="trTechRF" runat="server" style="display:none;">
                        ...
                        <td class="tdRowValue">
                            <table border="0">
                                <tr>
                                    <td colspan="2">
                                        <asp:DataList ID="dlTechRF" runat="server" DataSourceID="sdsTechRF" 
                                            DataKeyField="wowi_tech_id" RepeatColumns="2" RepeatDirection="Horizontal" OnItemDataBound="dlTech_ItemDataBound">
                                            <ItemTemplate>
                                                <table border="0">
                                                    <tr>
