<%@ WebHandler Language="C#" Class="SampleShippingFile" %>
...
public class SampleShippingFile : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        if ((context.Request["fid"] != null))
        {
            ...
            cmd.CommandText = "select * from Ima_SampleShipping_Files where SampleShippingFileID=@SampleShippingFileID";
            cmd.Parameters.AddWithValue("@SampleShippingFileID", context.Request["fid"]);
