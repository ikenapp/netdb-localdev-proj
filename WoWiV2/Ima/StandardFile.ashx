<%@ WebHandler Language="C#" Class="StandardFile" %>
...
public class StandardFile : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        if ((context.Request["fid"] != null))
        {
            ...
            cmd.CommandText = "select * from Ima_Standard_Files where StandardFileID=@StandardFileID";
            cmd.Parameters.AddWithValue("@StandardFileID", context.Request["fid"]);
