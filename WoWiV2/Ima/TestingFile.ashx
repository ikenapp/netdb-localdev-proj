<%@ WebHandler Language="C#" Class="TestingFile" %>
...
public class TestingFile : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        if ((context.Request["fid"] != null))
        {
            ...
            cmd.CommandText = "select * from Ima_Testing_Files where TestingFileID=@TestingFileID";
            cmd.Parameters.AddWithValue("@TestingFileID", context.Request["fid"]);
