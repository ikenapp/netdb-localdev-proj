...
<table align="center" class="quoEdit" border="1" cellpadding="0" cellspacing="0"
  ...
  <tr>
    ...
    <td>
      ...
      <asp:SqlDataSource ID="SqlDataSourceSalesAL" runat="server" ConnectionString="<%$ ConnectionStrings:WoWiConnectionString %>"
        SelectCommand="select access_level.id,access_level.name
from access_level
where access_level.name like '%Sales%' and publish=1"></asp:SqlDataSource>
  ...
  <tr>
    ...
    <td>
      <asp:TextBox ID="txtProductName" runat="server" Width="97%" MaxLength="500"></asp:TextBox>
    </td>
  </tr>
  <tr>
    <th class="style4">
    ...
    <td>
      <asp:TextBox ID="txtCProductName" runat="server" Width="97%" MaxLength="500"></asp:TextBox>
    </td>
  </tr>
  <tr>
    <th class="style4">
    ...
    <td>
      <asp:TextBox ID="txtModelNo" runat="server" Width="97%" MaxLength="500"></asp:TextBox>
    </td>
  </tr>
  <tr>
    <th class="style4">
    ...
    <td>
      <asp:TextBox ID="txtCModelNo" runat="server" Width="97%" MaxLength="500"></asp:TextBox>
    </td>
  </tr>
  <tr>
    <th class="style4">
    ...
    <td>
      <asp:TextBox ID="txtBrandName" runat="server" Width="97%" MaxLength="500"></asp:TextBox>
    </td>
  </tr>
  <tr>
    <th class="style4">
    ...
    <td>
      <asp:TextBox ID="txtCBrandName" runat="server" Width="97%" MaxLength="500"></asp:TextBox>
    </td>
  </tr>
  <tr>
    <th class="style4">
    ...
    <td>
      <asp:TextBox ID="txtModelDifference" runat="server" Width="97%" MaxLength="500"></asp:TextBox>
    </td>
  </tr>
  <tr>
    <th class="style4">
  ...
  <tr>
    ...
    <td>
      ...
      <asp:DropDownList ID="DropDownListContact" runat="server" AutoPostBack="True" DataSourceID="SqlDataSourceContact"
        DataTextField="fullname" DataValueField="id" OnSelectedIndexChanged="DropDownListContact_SelectedIndexChanged"
      ...
      <asp:SqlDataSource ID="SqlDataSourceContact" runat="server" ConnectionString="<%$ ConnectionStrings:WoWiConnectionString %>"
        ...
        <SelectParameters>
          <asp:ControlParameter ControlID="DropDownListEmp" Name="employee_id" PropertyName="SelectedValue" />
          <asp:ControlParameter ControlID="DropDownListClient" Name="client_id" PropertyName="SelectedValue" />
        </SelectParameters>
      </asp:SqlDataSource>
  ...
  <tr>
    ...
    <td>
      <asp:DropDownList ID="DropDownListApp" runat="server" AutoPostBack="True" DataSourceID="SqlDataSourceApp"
        DataTextField="companyname" DataValueField="Id" OnDataBound="DropDownListApp_DataBound">
      </asp:DropDownList>
  ...
  <tr>
    <th colspan="2" style="text-align: left;">
      ...
      <asp:SqlDataSource ID="SqlDataSourceContact2" runat="server" ConnectionString="<%$ ConnectionStrings:WoWiConnectionString %>"
        ...
        <SelectParameters>
          <asp:ControlParameter ControlID="DropDownListEmp" Name="employee_id" PropertyName="SelectedValue" />
          <asp:ControlParameter ControlID="DropDownListClient2" Name="client_id" PropertyName="SelectedValue" />
        </SelectParameters>
      </asp:SqlDataSource>
    </th>
  </tr>
  ...
  <tr>
    ...
    <td>
      <asp:TextBox ID="txtBillCompanyname" runat="server" Width="500px" MaxLength="100"></asp:TextBox>
    </td>
  </tr>
  <tr>
    <th class="style4">
  ...
  <tr>
    ...
    <td>
      <asp:TextBox ID="txtBill_CCompanyname" runat="server" Width="500px" MaxLength="100"></asp:TextBox>
    </td>
  </tr>
  <tr>
    <th class="style4">
  ...
  <tr>
    ...
    <td>
      <asp:DropDownList ID="ddlPaymentDays" runat="server" SelectedValue='<%# Bind("paymentdays") %>'>
