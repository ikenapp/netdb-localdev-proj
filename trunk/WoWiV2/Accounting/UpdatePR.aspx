        ...
        try
        {
          ...
          switch (st)
          {
            ...
            case PRStatus.Requisitioner:
              ...
              {
                PRUtils.SupervisorList.Clear();
                PRUtils.GetSupervisorByEmpID((int)auth.supervisor_id);
                if (empid == auth.supervisor_id || PRUtils.SupervisorList.Exists(s => s == empid))
                {
                  btn.Enabled = true;
                  EnableInput(true);
                }
            ...
            case PRStatus.Supervisor:
              ...
              {
                PRUtils.SupervisorList.Clear();
                PRUtils.GetSupervisorByEmpID((int)auth.vp_id);
                if (empid == auth.vp_id || PRUtils.SupervisorList.Exists(s => s == empid))
                {
                  btn.Enabled = true;
                  EnableInput(true);
                }
            ...
            case PRStatus.VicePresident:
              ...
              {
                PRUtils.SupervisorList.Clear();
                PRUtils.GetSupervisorByEmpID((int)auth.president_id);
                if (empid == auth.president_id || PRUtils.SupervisorList.Exists(s => s == empid))
                {
                  btn.Enabled = true;
                  EnableInput(true);
                }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
  <asp:FormView ID="FormView1" runat="server" DataKeyNames="pr_id" SkinID="FormView"
      ...
      <table align="left" border="0" cellpadding="2" cellspacing="0" style="width: 100%">
        <tr>
          <th align="left" class="style10">
            <font size="+1">&nbsp;Purchase Request 
                  Id = <asp:Label ID="lblPRNo" runat="server" Text='<%# Eval("pr_id") %>'></asp:Label> 
                 &nbsp;</font>
            <%--<asp:HyperLink 
                           ID="HyperLink1" runat="server" NavigateUrl="~/Accounting/PRList.aspx">PR List</asp:HyperLink>--%>&#160;
          </th>
        </tr>
        <tr>
          <td>
            <table align="center" border="1" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td align="right" class="style11" colspan="4">
                  <%--Access Level : <asp:Label ID="lblDept" runat="server" Text="" 
                                         onload="lbl_Load" />&nbsp;&nbsp;&nbsp;&nbsp;Created by : 
                                     <asp:Label ID="lblEmp" runat="server" Text="" 
                                         onload="lbl_Load" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;--%>Create
                  Date :
                  <asp:Label ID="lblCDate" runat="server" Text="" OnLoad="lbl_Load"></asp:Label>
                </td>
              </tr>
              ...
              <tr>
                <th align="left" class="style9">
                  <font color="red">*&#160;</font>Access Level:
                </th>
                <td width="30%">
                  <netdb:DropDownList2 ID="ddlDeptList" runat="server" AppendDataBoundItems="true"
                    DataSourceID="SqlDataSource4" DataTextField="name" DataValueField="id" ValidationGroup="VenderGroup"
                    SelectedValue='<%# Bind("department_id") %>'>
                    <asp:ListItem Value="-1">- Select -</asp:ListItem>
                  </netdb:DropDownList2>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlDeptList"
                    ErrorMessage="Please select access level." Font-Bold="True" ForeColor="Red" InitialValue="-1"
                    ValidationGroup="VenderGroup">*</asp:RequiredFieldValidator>
                  <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:WoWiConnectionString %>"
                    SelectCommand="SELECT [id], [name] FROM [access_level] WHERE [publish] = 'true' order by [name]">
                  </asp:SqlDataSource>
                </td>
                <th align="left" class="style7">
                  <font color="red">*&#160;</font>Created by:
                </th>
                <td width="30%">
                  <netdb:DropDownList2 ID="ddlEmployeeList" runat="server" AppendDataBoundItems="true"
                    SelectedValue='<%# Bind("employee_id") %>' DataSourceID="SqlDataSource7" DataTextField="name"
                    DataValueField="id">
                    <asp:ListItem Value="-1">- Select -</asp:ListItem>
                  </netdb:DropDownList2>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlEmployeeList"
                    ErrorMessage="Please select created by which user." Font-Bold="True" ForeColor="Red"
                    InitialValue="-1" ValidationGroup="VenderGroup">*</asp:RequiredFieldValidator>
                  <asp:SqlDataSource ID="SqlDataSource7" runat="server" ConnectionString="<%$ ConnectionStrings:WoWiConnectionString %>"
                    SelectCommand="SELECT [id], ([fname]+[lname] )as name FROM [employee] WHERE [status] = 'Active'">
                  </asp:SqlDataSource>
                </td>
              </tr>
              <tr>
                <th align="left" class="style11">
                  &nbsp;&nbsp;&nbsp; <span class="style12">Project No.:&nbsp;</span>&nbsp;
                </th>
                <td class="style12" width="30%">
                  <asp:Label ID="lblProjectNo" runat="server" Text="Label" OnLoad="lblProjectNo_Load"
                ...
                <td class="style12" width="30%">
                  <asp:Label ID="lblQuotationNo" runat="server" Text="Label" OnLoad="lblQuotationNo_Load"></asp:Label>
                </td>
              </tr>
              <tr>
                <th align="left" class="style11">
                ...
                <td class="style12" width="30%">
                  <asp:TextBox ID="tbVenderQuoNo" runat="server" Text='<%# Bind("vendor_quotation_no")%>'></asp:TextBox>
                </td>
                <th align="left" class="style11">
                  &nbsp; Vender Invoice No.:&nbsp;
                </th>
                <td class="style12" width="30%">
                  <asp:TextBox ID="tbVenderInvoNo" runat="server" Text='<%# Bind("vendor_invoice_no")%>'></asp:TextBox>
                </td>
              </tr>
              <tr>
                <th align="left" class="style11">
                  &nbsp;&nbsp; <span class="style12">Payment Term:&nbsp;</span>&nbsp;
                </th>
                <td class="style12" colspan="3">
                  <netdb:DropDownList2 ID="ddlPaymentTerm" runat="server" SelectedValue='<%# Bind("payment_term") %>'
                    Font-Bold="True">
              ...
              <tr>
                <th align="left" class="style11">
                  &nbsp;<span class="style12">&nbsp; Target:&nbsp;</span>&nbsp;
                </th>
                <td class="style12" colspan="3">
                  <netdb:DropDownList2 ID="ddlTarget" runat="server" OnLoad="ddlTarget_Load" AppendDataBoundItems="true"
                    ValidationGroup="VenderGroupT" Font-Bold="True">
                    <asp:ListItem Value="-1">- Select -</asp:ListItem>
                  </netdb:DropDownList2>
                  &nbsp;<asp:Button ID="btnAddItem" runat="server" Text="Add" OnClick="AddItem_Click"
                    CausesValidation="False" Visible="false" ValidationGroup="VenderGroupT" OnLoad="btnAddItem_Load" />
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlTarget"
                    ErrorMessage="Please select vender!" ForeColor="Red" InitialValue="-1" ValidationGroup="VenderGroupT">*</asp:RequiredFieldValidator>
                  <asp:ValidationSummary ID="ValidationSummary2" runat="server" ShowMessageBox="True"
                    ShowSummary="False" ValidationGroup="VenderGroupT" />
                </td>
              </tr>
              <tr>
                <td colspan="4">
                  <asp:GridView ID="GridView4" runat="server" Width="100%" AutoGenerateColumns="False">
                    <Columns>
                      <asp:BoundField DataField="QuotataionNo" HeaderText="Quotation No" SortExpression="QuotataionNo" />
              ...
              <tr>
                <th align="left" class="style11">
                  &nbsp;&nbsp;&nbsp;<span class="Currency">Original Currency:&nbsp;</span>&nbsp;
                </th>
                <td class="style12" width="30%">
                  <asp:TextBox ID="tbCurrency" runat="server" Text='<%# Bind("currency")%>' ForeColor="Blue"></asp:TextBox>
                </td>
                <th align="left" class="style11">
                  &nbsp; <span class="Currency">Total:</span>&nbsp;
                </th>
                <td class="style12" width="30%">
                  <asp:TextBox ID="tbTotalAmount" runat="server" Text='<%# Bind("total_cost")%>' ForeColor="Blue"></asp:TextBox>
                </td>
              </tr>
              <tr>
                <th align="left" class="style11">
                  &nbsp;&nbsp;&nbsp;<span class="Currency">Authorization Currency:&nbsp;</span>&nbsp;
                </th>
                <td class="style12" width="30%">
                  <span class="Currency">USD</span>
                </td>
                <th align="left" class="style11">
                  <font color="red">*&#160;</font><span class="Currency">Authorization Total:</span>&nbsp;
                </th>
                <td class="style12" width="30%">
                  <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("shipping_cost")%>' ForeColor="Blue"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBox4"
                    ErrorMessage="Please provide USD Authoriaztion Total" Font-Bold="True" ForeColor="Red"
                    ValidationGroup="VenderGroup">*</asp:RequiredFieldValidator>
                </td>
              </tr>
              <tr>
                ...
                <td class="style12" colspan="3">
                  <netdb:DropDownList2 ID="ddlVenderList" runat="server" AppendDataBoundItems="True"
                    AutoPostBack="True" OnLoad="ddlVenderList_Load" OnSelectedIndexChanged="ddlVenderList_SelectedIndexChanged"
                    ValidationGroup="VenderGroup">
                    <asp:ListItem Value="-1">- Select -</asp:ListItem>
                  </netdb:DropDownList2>
                  &nbsp;<asp:Button ID="btnShow" runat="server" Text="Show" Visible="false" OnClick="btnShow_Click"
                    ValidationGroup="VenderGroup" CausesValidation="false" />
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlVenderList"
                    ErrorMessage="Please select vender!" ForeColor="Red" InitialValue="-1" ValidationGroup="VenderGroup">*</asp:RequiredFieldValidator>
                  <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True"
                    ShowSummary="False" ValidationGroup="VenderGroup" />
                </td>
              </tr>
              <asp:Panel ID="VenderPanel" runat="server" Visible="true">
                        ...
                        <td>
                          <table align="center" border="1" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                              ...
                              <td class="style12" width="30%">
                                <asp:Label ID="lbcCompany" runat="server"></asp:Label>
                              </td>
                            </tr>
                            <tr>
                              <th align="left" class="style9">
                              ...
                              <td width="30%">
                                <asp:Label ID="lbTel1" runat="server"></asp:Label>&#160;&#160;&#160;&#160;&#160;
                              </td>
                              <th align="left" class="style7">
                                &nbsp;&nbsp; Fax1:
                              </th>
                              <td width="30%">
                                <asp:Label ID="lbFax1" runat="server"></asp:Label>
                              </td>
                            </tr>
                            <tr>
                              <th align="left" class="style9">
                              ...
                              <td width="30%">
                                <asp:Label ID="lbTel2" runat="server"></asp:Label>
                              </td>
                              <th align="left" class="style7">
                                &nbsp;&nbsp; Fax2:&nbsp;
                              </th>
                              <td width="30%">
                                <asp:Label ID="lbFax2" runat="server"></asp:Label>
                              </td>
                            </tr>
                            <tr>
                              <th align="left" class="style9">
                              ...
                              <td width="30%">
                                <asp:Label ID="lbAddress" runat="server" Width="211px"></asp:Label>
                              </td>
                              <th align="left" class="style7">
                                &#160; 地址:&#160;
                              </th>
                              <td width="30%">
                                <asp:Label ID="lbcAddress" runat="server" Width="211px"></asp:Label>
                              </td>
                            </tr>
                            <tr>
                              <th align="left" class="style9">
                              ...
                              <td width="30%">
                                <netdb:DropDownList2 ID="ddlCountry" runat="server" Enabled="false" DataSourceID="SqlDataSource1"
                            ...
                            <tr>
                              ...
                              <td width="30%">
                                <netdb:DropDownList2 ID="ddlQualification" runat="server" Enabled="false">
                              ...
                              <td width="30%">
                                <netdb:DropDownList2 DataSourceID="SqlDataSource3" DataTextField="name" DataValueField="id"
                                  Enabled="false" ID="ddlContractType" runat="server" AppendDataBoundItems="true">
                                  <asp:ListItem Value="-1">- Select -</asp:ListItem>
                                </netdb:DropDownList2>
                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:WoWiConnectionString %>"
                                  SelectCommand="SELECT [id], [name] FROM [vendor_type] WHERE [publish] = 'true'">
                                </asp:SqlDataSource>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <th align="left" class="style11">
                                <font color="red">*&nbsp;</font>Target Payment Day:&nbsp;&nbsp;
                              </th>
                              <td class="style12" width="30%">
                ...
                <tr>
                  <td align="left" colspan="4">
                    <asp:Label runat="server" ID="lblC" Text="Contact :"></asp:Label><netdb:DropDownList2
                      AutoPostBack="True" ID="ddlContact" runat="server" OnSelectedIndexChanged="ddlContact_SelectedIndexChanged">
                    </netdb:DropDownList2>
                ...
                <tr>
                  <td align="left" colspan="4">
                    ...
                    <netdb:DropDownList2 AutoPostBack="True" ID="ddlBankAccount" runat="server" OnSelectedIndexChanged="ddlBankAccount_SelectedIndexChanged">
                    </netdb:DropDownList2>
                  </td>
                </tr>
                <tr>
                  <td align="left" colspan="4">
                    ...
                    <asp:GridView ID="GridView2" runat="server" Width="100%" AutoGenerateColumns="False"
                      Visible="false" OnPreRender="GridView1_PreRender">
                      <Columns>
                ...
                <td colspan="4">
                  <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr align="center">
                      ...
                      <td>
                        <asp:TextBox ID="tbInternalMarksHis" runat="server" TextMode="MultiLine" Width="510px"
                          Height="100px" ReadOnly="true" OnLoad="AuthLabel_Load"></asp:TextBox><br />
                      </td>
                      <td align="right">
                        History:
                      </td>
                      <td>
                        <asp:TextBox ID="tbInstructionHis" runat="server" TextMode="MultiLine" Width="510"
                          ReadOnly="true" Height="100px" OnLoad="AuthLabel_Load"></asp:TextBox><br />
                      </td>
                    </tr>
              </tr>
              <tr align="center">
                ...
                <td>
                  <asp:TextBox ID="tbInternalMarks" runat="server" Height="50px" TextMode="MultiLine"
                    Width="510px" OnLoad="AuthLabel_Load"></asp:TextBox>
                </td>
                <td>
                </td>
                <td>
                  <asp:TextBox ID="tbInstruction" runat="server" Height="50px" TextMode="MultiLine"
                    Width="510" OnLoad="AuthLabel_Load"></asp:TextBox>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <asp:Button ID="btnSendReq" runat="server" Text="SendRequest" OnClick="btnSendReq_Click"
                    OnLoad="btn_Load" />
                </td>
                <td>
                </td>
                ...
                <td>
                  Date :
                  <asp:Label ID="lblRequisitionerDate" runat="server" Text="" OnLoad="AuthLabel_Load"></asp:Label>
                </td>
                <%--<td rowspan="3">
                                     Internal Remarks:<br/>
              ...
              <tr>
                ...
                <td>
                  <asp:Button ID="btnSupervisorApprove" runat="server" Text="Approve" OnLoad="btn_Load"
                    OnClick="btn_Click" />
                </td>
                <td>
                  <asp:Button ID="btnSupervisorDisapprove" runat="server" Text="Disapprove" OnLoad="btn_Load"
                    OnClick="btn_Click" />
                </td>
                <td>
                ...
                <td>
                  Date :
                  <asp:Label ID="lblSupervisorDate" runat="server" Text="" OnLoad="AuthLabel_Load"></asp:Label>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <asp:Button ID="btnVPDisapprove" runat="server" Text="Disapprove" OnLoad="btn_Load"
                    OnClick="btn_Click" />
                </td>
                <td>
                ...
                <td>
                  Date :
                  <asp:Label ID="lblVPDate" runat="server" Text="" OnLoad="AuthLabel_Load"></asp:Label>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <asp:Button ID="btnPresidentApprove" runat="server" Text="Approve" OnLoad="btn_Load"
                    OnClick="btn_Click" />
                </td>
                <td>
                  <asp:Button ID="btnPresidentDisapprove" runat="server" Text="Disapprove" OnLoad="btn_Load"
                    OnClick="btn_Click" />
                </td>
                <td>
                ...
                <td>
                  Date :
                  <asp:Label ID="lblPresidentDate" runat="server" Text="" OnLoad="AuthLabel_Load"></asp:Label>
                </td>
                <%--<td rowspan="3">
              ...
              <tr>
                ...
                <td>
                  <asp:Button ID="btnCancel" runat="server" Text="Withdraw" OnLoad="btn_Load" OnClick="btnCancel_Click"
                    OnPreRender="btnCancel_PreRender" />
                </td>
                <td>
                </td>
                <td>
                ...
                <td>
                  <asp:Label ID="lblStatus" runat="server" OnLoad="AuthLabel_Load" Font-Bold="True"
              ...
              <tr align="center">
                <td>
                  <asp:LinkButton ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Update"
                    Text="Finish" ValidationGroup="VenderGroup" />
                  &nbsp;
  ...
  <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=WoWiEntities"
    DefaultContainerName="WoWiEntities" EnableInsert="True" EntitySetName="PRs" OnUpdated="EntityDataSource1_Updated"
    Where="it.pr_id == @id" OnUpdating="EntityDataSource1_Updating" EnableUpdate="True">
    <WhereParameters>
