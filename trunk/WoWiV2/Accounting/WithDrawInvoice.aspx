      ...
      <table align="center" border="1" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          ...
          <td align="right" colspan="2">
            ...
            &nbsp;&nbsp;
            <asp:Button ID="Button2" runat="server" Text="Print List" OnClick="Button2_Click"
              Enabled="False" />
          </td>
        </tr>
      </table>
      ...
      <asp:GridView ID="iGridView1" runat="server" Height="150px" Width="100%" SkinID="GridView"
        ...
        <Columns>
          <asp:TemplateField HeaderText="">
            ...
            <ItemTemplate>
              <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Bind("id","~/Accounting/InvoiceDetails.aspx?id=-{0}") %>'
