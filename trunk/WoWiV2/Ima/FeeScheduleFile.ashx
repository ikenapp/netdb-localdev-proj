<%@ WebHandler Language="C#" Class="FeeScheduleFile" %>
...
public class FeeScheduleFile : IHttpHandler {
    
    public void ProcessRequest (HttpContext context) {
        if ((context.Request["fid"] != null))
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "select * from Ima_FeeSchedule_Files where FeeScheduleFileID=@FeeScheduleFileID";
            cmd.Parameters.AddWithValue("@FeeScheduleFileID", context.Request["fid"]);
