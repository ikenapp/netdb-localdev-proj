...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function getSelect() {
            ...
            else if (ddlTech.val() == 'Below 1G SRD') { plBelow1GSRD.css("display", ""); plBelow1GSRD.css("padding-top", "0px"); }
            else if (ddlTech.val() == 'Above 1G SRD') { plAbove1GSRD.css("display", ""); plAbove1GSRD.css("padding-top", "0px"); }
                                ...
                                <table cellpadding="1" cellspacing="1" border="0" class="tbEditItem" align="left">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdRowValue">
                                            <table border="0" cellpadding="0" cellspacing="0" align="left">
                                                <tr>
                                                    <td align="left"><asp:Label ID="lblWiFiDFS1" runat="server"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td align="left"><asp:Label ID="lblWiFiTPC1" runat="server"></asp:Label></td>
                                                </tr>
                                                <tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:Panel ID="plBelow1GSRD" runat="server" ScrollBars="Auto">
                                <table cellpadding="1" cellspacing="1" border="0" class="tbEditItem" align="left" width="500px">
                                    <tr>
                                        <td colspan="5" class="tdHeader">Below 1G SRD Detail</td>
                                    </tr>
                                    <tr>
