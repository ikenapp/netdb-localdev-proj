                ...
                <td valign="top">
                    <table cellpadding="1" cellspacing="1" border="0" class="tbEditItem">
                        ...
                        <tr>
                            ...
                            <td class="tdRowValue" align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblLanguageDescS" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="tdRowValue">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblTestMarkS" runat="server"></asp:Label>
                                            <asp:Label ID="lblTestMarkRemarkS" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="tdRowValue" align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblCertificationS" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblOtherInternationallyS" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="tdRowValue" align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblTechnicalDocsS" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblTechnicalS" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblAntennaS" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="tdRowValue">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblOtherDoc1S" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblOtherDocRequestS" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="tdRowValue">
                                <asp:Label ID="lblRadiatedS" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdRowName" valign="top">
                            ...
                            <td class="tdRowValue">
                                <asp:Label ID="lblConductedS" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdRowName" valign="top">
                            ...
                            <td class="tdRowValue">
                                <asp:Label ID="lblNormalLinkS" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdRowName" valign="top">
                            ...
                            <td class="tdRowValue">
                                <asp:Label ID="lblReviewOnlyS" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdRowName" valign="top">
