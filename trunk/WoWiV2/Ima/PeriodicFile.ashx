<%@ WebHandler Language="C#" Class="Periodic" %>
...
public class Periodic : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        if ((context.Request["fid"] != null))
        {
            ...
            cmd.CommandText = "select * from Ima_Periodic_Files where PeriodicFileID=@PeriodicFileID";
            cmd.Parameters.AddWithValue("@PeriodicFileID", context.Request["fid"]);
