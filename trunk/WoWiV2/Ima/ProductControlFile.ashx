<%@ WebHandler Language="C#" Class="ProductControlFile" %>
...
public class ProductControlFile : IHttpHandler
{    
    public void ProcessRequest (HttpContext context) {        
        if ((context.Request["fid"] != null)) 
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "select * from Ima_ProductsControl_Files where ProductControlFileID=@FileID";
