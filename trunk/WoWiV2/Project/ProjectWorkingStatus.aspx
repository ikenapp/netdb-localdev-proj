<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="ProjectWorkingStatus.aspx.cs" Inherits="Project_ProjectWorkingStatus" %>
...
<asp:Panel ID="pnlWorkingStatusManagement" runat="server">        
        ...
        <fieldset>
            ...
            Project：<asp:DropDownList ID="ddlWorkingStatusProject" runat="server" AutoPostBack="True" 
                ...
                DataValueField="Project_Id" EnableTheming="False" 
                onselectedindexchanged="ddlWorkingStatusProject_SelectedIndexChanged" 
...
INNER JOIN Quotation_Version ON [Project].Quotation_Id = Quotation_Version.Quotation_Version_Id">
                ...
                AutoPostBack="True" DataSourceID="ProjectCountrySqlDataSource" 
...
(Select Quotation_NO FROM Project Where Project_Id = @Project_Id))">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    Target：<asp:DropDownList ID="ddlWorkingStatusTarget" runat="server" 
                AutoPostBack="True" DataSourceID="WorkingStatusTargetSqlDataSource" 
                DataTextField="authority_name" DataValueField="Quotation_Target_Id" EnableTheming="False" 
                ondatabound="ddlWorkingStatusTarget_DataBound" 
...
Quotation_Target.country_id = @country_id  ">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="ddlWorkingStatusProject" Name="project_id" 
                                PropertyName="SelectedValue" Type="String" />
                            <asp:ControlParameter ControlID="ddlWorkingStatusCountry" Name="country_id" 
            ...
            CellPadding="4" DataKeyNames="log_id" 
            EmptyDataText="沒有資料可以顯示。" 
            ForeColor="#333333" HorizontalAlign="Center" RowHeaderColumn="id" 
            ShowHeaderWhenEmpty="True" Width="100%" EnablePersistedSelection="True" 
                EnableTheming="False" onrowdatabound="gvWorkingStatus_RowDataBound" 
                PageSize="30">
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>
                <asp:BoundField DataField="log_id" HeaderText="ID" InsertVisible="False" 
                    ReadOnly="True" SortExpression="log_id" >
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="log_date" HeaderText="Display Date" 
                    SortExpression="log_date" ApplyFormatInEditMode="True" 
                    DataFormatString="{0:d}" ReadOnly="True" >
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="log_content" HeaderText="Working Status" 
                    HtmlEncode="False" ReadOnly="True" >
                </asp:BoundField>
                <asp:BoundField DataField="create_date" HeaderText="Create Date" 
                    SortExpression="create_date" DataFormatString="{0:d}" ReadOnly="True" >
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="create_by" HeaderText="Create By" 
                    SortExpression="create_by" ReadOnly="True" >
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:CheckBoxField DataField="external_use" HeaderText="External" 
                    SortExpression="external_use">
                <ItemStyle HorizontalAlign="Center" />
                </asp:CheckBoxField>
                <asp:TemplateField HeaderText="Voided" InsertVisible="False" 
                    SortExpression="voided">
                    <EditItemTemplate>
                ...
                <asp:CommandField CancelText="Cancel" CausesValidation="False" EditText="Edit" 
            ...
            <asp:SqlDataSource ID="gvWorkingStatusSqlDataSource" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ApplicationServices %>" 
                SelectCommand="sp_get_working_status_by_target_id" 
                SelectCommandType="StoredProcedure" 
                UpdateCommand="sp_update_working_status" 
                UpdateCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:ControlParameter ControlID="ddlWorkingStatusTarget" Name="target_id" 
            ...
            <asp:DetailsView ID="dvWorkingStatus" runat="server" Width="100%" 
                AutoGenerateRows="False" CellPadding="4" DataKeyNames="log_id" 
                DataSourceID="dvWorkingStatusSqlDataSource" DefaultMode="Insert" 
                EnableTheming="False" ForeColor="#333333" 
                oniteminserted="dvWorkingStatus_ItemInserted" Visible="False" 
                ondatabound="dvWorkingStatus_DataBound">
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                <CommandRowStyle BackColor="#E2DED6" Font-Bold="True" />
                <EditRowStyle BackColor="#999999" />
                <FieldHeaderStyle BackColor="#E9ECF1" Font-Bold="True" />
                <Fields>
                    <asp:CommandField CancelText="Cancel" InsertText="Save" NewText="Add" 
                        ShowInsertButton="True" ValidationGroup="AddWorkingStatus">
                    ...
                    <asp:BoundField DataField="target_id" HeaderText="Target" 
                        InsertVisible="False" />
                    <asp:TemplateField HeaderText="Display Date">
                        ...
                        <InsertItemTemplate>
                            <asp:TextBox ID="txtLogDate" runat="server" 
                                ValidationGroup="AddWorkingStatus" Text='<%# Bind("log_date") %>' EnableTheming="False">
                            </asp:TextBox>
                            <asp:CalendarExtender ID="txtLogDate_CalendarExtender" runat="server" 
                                Enabled="True" Format="yyyy/MM/dd" TargetControlID="txtLogDate" 
                                TodaysDateFormat="yyyy/MM/dd">
                            </asp:CalendarExtender>
                            <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                    ControlToValidate="txtLogDate" Display="None" EnableTheming="False" 
                                    ErrorMessage="<strong>Required Field Missing</strong><br />&nbsp;&nbsp;Please enter a valid date." 
                                    ForeColor="Red" Operator="DataTypeCheck" 
                                    SetFocusOnError="True" Type="Date" ValidationGroup="AddWorkingStatus">
                             </asp:CompareValidator>
                            <asp:ValidatorCalloutExtender ID="ValidatorCalloutExtender1" 
                                runat="server" Enabled="True" HighlightCssClass="RequiredFieldHighlight" 
                                TargetControlID="CompareValidator1" Width="250px" PopupPosition="Right">
                            </asp:ValidatorCalloutExtender>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                    ControlToValidate="txtLogDate" Display="None" EnableTheming="False" 
                                    ErrorMessage="<strong>Required Field Missing</strong><br />&nbsp;&nbsp;Date is required." 
                                    ForeColor="Red" 
                                    SetFocusOnError="True" ValidationGroup="AddWorkingStatus">
                    ...
                    <asp:TemplateField HeaderText="Working Status">
                        ...
                        <InsertItemTemplate>
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>                            
                                        <asp:DropDownList ID="ddlworkingStatusTemplate1" runat="server" 
                                            AutoPostBack="True" EnableTheming="False" 
                                            onselectedindexchanged="ddlworkingStatusTemplate1_SelectedIndexChanged">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlworkingStatusTemplate2" runat="server" 
                                            AutoPostBack="True" EnableTheming="False" 
                                            onselectedindexchanged="ddlworkingStatusTemplate2_SelectedIndexChanged">
                                            <asp:ListItem Value="">Select a template....</asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlworkingStatusTemplate3" runat="server" 
                                            AutoPostBack="True" EnableTheming="False" 
                                            onselectedindexchanged="ddlworkingStatusTemplate3_SelectedIndexChanged">
                                            <asp:ListItem Value="">Select a template....</asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlworkingStatusTemplate4" runat="server" 
                                            AutoPostBack="True" EnableTheming="False" 
                                            onselectedindexchanged="ddlworkingStatusTemplate4_SelectedIndexChanged">
                                            <asp:ListItem Value="">Select a template....</asp:ListItem>
                        ...
                        <br />
                        <asp:TextBox ID="txtLogContent" runat="server" 
                            EnableTheming="False" Rows="5" TextMode="MultiLine" Width="450" 
                            ValidationGroup="AddWorkingStatus" 
                            Text='<%# Bind("log_content") %>'>
                        </asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                ControlToValidate="txtLogContent" Display="None" EnableTheming="False" 
                                ErrorMessage="<strong>Required Field Missing</strong><br />&nbsp;&nbsp;Working Status is required." 
                                ForeColor="Red" 
                                SetFocusOnError="True" ValidationGroup="AddWorkingStatus">
                        </asp:RequiredFieldValidator>
                        <asp:ValidatorCalloutExtender ID="ValidatorCalloutExtender3" 
                            runat="server" Enabled="True" HighlightCssClass="RequiredFieldHighlight" 
                            TargetControlID="RequiredFieldValidator3" Width="250px" PopupPosition="BottomLeft">
                        </asp:ValidatorCalloutExtender>
                        </InsertItemTemplate>
                        <ItemTemplate>
            ...
            <asp:SqlDataSource ID="dvWorkingStatusSqlDataSource" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ApplicationServices %>" 
                InsertCommand="sp_add_working_status" InsertCommandType="StoredProcedure" 
                SelectCommand="sp_get_working_status_by_target_id" 
                SelectCommandType="StoredProcedure">
                <InsertParameters>
                    <asp:ControlParameter ControlID="ddlWorkingStatusTarget" Name="target_id" 
