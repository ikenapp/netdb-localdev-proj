...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        ...
        <asp:SqlDataSource ID="SqlDataSourceCountry" runat="server" ConnectionString="<%$ ConnectionStrings:WoWiConnectionString %>"
            DeleteCommand="DELETE FROM [country] WHERE [country_id] = @country_id" InsertCommand="INSERT INTO [country] ([country_id], [country_name], [country_3_code], [country_2_code], [world_region_id],[country_telephone_code],[country_currency_type]) VALUES (@country_id, @country_name, @country_3_code, @country_2_code, @world_region_id,@country_telephone_code,@country_currency_type)"
            ...
            UpdateCommand="STP_CountryEdit" UpdateCommandType="StoredProcedure">
