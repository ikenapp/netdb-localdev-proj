...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Cost Currency" 
                SortExpression="target_cost_currency">
                <ItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSourceTarget" runat="server" 
        ...
        SelectCommand="select [Target].[target_id],[Target].[country_id],[Target].[product_type_id],[Target].[authority_id],[Target].[technology_id],[target_code],[target_description],[target_cost],[target_cost_currency],country.country_name, wowi_product_type.wowi_product_type_name, wowi_tech.wowi_tech_name ,Target_Rates.rate,Target_Rates.authority_name
